...
public class Filme {
	...
	public Filme(int id, String titulo, String descricao, String nome_arquivo, String nome_capa, Integer duracao,
			Integer ano, String genero, String atores, Date data_cadastro, int qtde_likes, int qtde_dislikes) {
		super();
		this.id = id;
		this.titulo = titulo;
